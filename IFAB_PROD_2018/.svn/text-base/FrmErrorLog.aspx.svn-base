<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="FrmErrorLog.aspx.vb"
                        ...
                        <Columns>
                         ...
                         <%--   <asp:TemplateField ShowHeader="False">
                            ...
                            <asp:TemplateField HeaderText="Institute">
                                <ItemTemplate>
                                    <asp:Label ID="l2" runat="server" Text='<%# Bind("InstitueName") %>'></asp:Label>
                                </ItemTemplate>
