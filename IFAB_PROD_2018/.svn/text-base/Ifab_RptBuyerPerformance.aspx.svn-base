<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="Ifab_RptBuyerPerformance.aspx.vb"
    Inherits="Ifab_RptBuyerPerformance" Title="Buyer Performance" %>
            ...
            <div>
                <center>
                    <table>
                        <tr>
                            <td align="center">
                                <h1 class="headingTxt">
                                    <asp:Label ID="LabelEm" runat="server" Text="BUYER PERFORMANCE REPORT" SkinID="lblRepRsz"
                ...
                <center>
                    <table class="custTable">
                        <tr>
                            <td align="right">
                                <asp:Label ID="Label3" runat="server"  Text="Buyer Name :" SkinID="lbl"></asp:Label>
                            </td>
                            <td align="left">
                                &nbsp<asp:DropDownList ID="ddlBuyerName" TabIndex="1" MaxLength="60" runat="server" SkinID="ddl"
                                    DataSourceID="ObjBuyerName" DataTextField="Company_Name" DataValueField="BuyerID">
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="ObjBuyerName" runat="server" SelectMethod="GetBuyerCompanyCobmo"
