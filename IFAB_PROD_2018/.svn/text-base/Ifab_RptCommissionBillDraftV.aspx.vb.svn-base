...
Partial Class Ifab_RptCommissionBillDraftV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Dim CommissionBillNo As String = "0000"
        QueryStr.GetValue(Page.Request, Prop)
        dt1 = DL.RptGetCommissionBillDraft(GrowerId, CommissionBillNo)
        dt2 = DLUnsoldFlower.GetUnsoldFlowerDetails(GrowerId, Date.Today, Date.Today)
        Try
            If dt1.Rows.Count > 0 Then
                ReportViewer1.LocalReport.ReportPath = "Ifab_RptCommissionBillDraft.rdlc"
                dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_CommisionBillReportDraft", dt1)
