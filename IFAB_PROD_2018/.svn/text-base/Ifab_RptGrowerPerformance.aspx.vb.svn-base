...
Partial Class Ifab_RptGrowerPerformance
    Inherits BasePage
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Try
            ...
            Dim qrystring As String = "Ifab_RptGrowerPerformanceV.aspx?" & QueryStr.Querystring() & "&fromdate=" & fromdate & "&todate=" & todate & "&GrowerID=" & GrowerID
