<%@ Page Title="AUCTION SHEET REPORT" Language="VB" MasterPageFile="~/Home.master"
    AutoEventWireup="false" CodeFile="Rpt_AuctionSheet.aspx.vb" Inherits="Rpt_AuctionSheet" %>
                    ...
                    <table>
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:ObjectDataSource runat="server" ID="ObjGrowerName" SelectMethod="GetDDlGrowerName"
                                    TypeName="DLRpt_AuctionSheet"></asp:ObjectDataSource>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                        ...
                        <tr>
                            <td colspan="2" class="btnTd">
                                <asp:Button ID="btnReport" runat="server" Text="REPORT" SkinID="btn" TabIndex="3"
