<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="frmApprovalTableConfig.aspx.vb"
    Inherits="frmApprovalTableConfig" Title="APPROVER TABLE CONFIGURATION" %>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 197px">
                                                    <asp:DropDownList ID="ddl4" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                                                        ...
                                                        Enabled="false" SkinID="ddlRsz" TabIndex="7">
                                                        <asp:ListItem Selected="true" Value="">Please Select</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
