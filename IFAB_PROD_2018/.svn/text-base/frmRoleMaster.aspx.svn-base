<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="frmRoleMaster.aspx.vb"
    Inherits="frmRoleMaster" Title="Role Master" EnableEventValidation="false" %>
