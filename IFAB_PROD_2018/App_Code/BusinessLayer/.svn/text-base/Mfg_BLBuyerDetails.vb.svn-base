...
Public Class Mfg_BLBuyerDetails
    ...
    End Function
    Public Function GetSupplierDetails(ByVal se As Mfg_ELBuyerDetails) As System.Data.DataTable
    ...
    End Function
    Public Function GetBuyerCompanyCobmo() As DataTable
        Return Mfg_DLBuyerDetails.GetBuyerCompanyCobmo()
    End Function
    Public Function GetGrowerCompanyCobmo() As DataTable
        Return Mfg_DLBuyerDetails.GetGrowerCompanyCobmo()
    End Function
End Class
