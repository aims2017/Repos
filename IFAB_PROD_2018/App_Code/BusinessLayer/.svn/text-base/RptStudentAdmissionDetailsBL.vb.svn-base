...
Public Class RptStudentAdmissionDetailsBL
    ...
    End Function
    Public Function GetBatch(ByVal AcademicYear As String, ByVal Courseid As Integer) As DataTable
        Return RptStudentAdmissionDetailsDL.GetBatch(AcademicYear, Courseid)
    End Function
