...
Public Class DLParentMngt
    ...
    Public Function SearchParent(ByVal U As ELParentMngt) As Data.DataTable
        ...
        Parms(5) = New SqlParameter("@RbId", SqlDbType.VarChar, 20)
        Parms(5).Value = U.Rbid
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "Proc_SearchGrowerUserDetails", Parms)
            Return ds.Tables(0)
    ...
    Shared Function GetParentDetails(ByVal p As ELParentMngt) As DataTable
        ...
        Try
            ...
            Parms(3) = New SqlParameter("@Rbid", SqlDbType.VarChar, 30)
            Parms(3).Value = p.Rbid

            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "Proc_GetGrower_BuyerUserDetails", Parms)
            Return ds.Tables(0)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    ...
    Shared Function InsertParentManagement(ByVal m As ELParentMngt) As Integer
        ...
        Parms(1) = New SqlParameter("@RbType", SqlDbType.VarChar, 50)
        Parms(1).Value = m.Rbid
        ...
        Parms(4) = New SqlParameter("@Growerid", SqlDbType.VarChar, 100)
        Parms(4).Value = m.Growerid
        ...
        Parms(6) = New SqlParameter("@EmpCode", SqlDbType.VarChar, 6000)
        Parms(6).Value = HttpContext.Current.Session("EmpCode")
        Parms(7) = New SqlParameter("@UserCode", SqlDbType.VarChar, 100)
    ...
    Shared Function UpdateParentDetails(ByVal m As ELParentMngt) As Integer
        ...
        Parms(2) = New SqlParameter("@Growerid", SqlDbType.VarChar, 100)
        Parms(2).Value = m.Growerid
        ...
        Parms(4) = New SqlParameter("@EmpCode", SqlDbType.VarChar, 6000)
        Parms(4).Value = HttpContext.Current.Session("EmpCode")
        Parms(5) = New SqlParameter("@UserCode", SqlDbType.VarChar, 100)
        Parms(5).Value = HttpContext.Current.Session("UserCode")
        Parms(6) = New SqlParameter("@Id", SqlDbType.Int)
        Parms(6).Value = m.Id
        Parms(7) = New SqlParameter("@BranchCode", SqlDbType.VarChar, 100)
        Parms(7).Value = HttpContext.Current.Session("BranchCode")
        Parms(8) = New SqlParameter("@RbType", SqlDbType.VarChar, 50)
        Parms(8).Value = m.Rbid
    ...
    Public Function RoleMap() As System.Data.DataTable
        ...
        End Try
    End Function
    'Shared Function getStudentNameBatchByCode(ByVal prefixText As String, ByVal Code As String) As DataTable
    '    Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
    '    Dim ds As DataSet
    ...
    '    arParms(3) = New SqlParameter("@Code", SqlDbType.VarChar, 30)
    '    arParms(3).Value = Code
    '    Try
    '        ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "Proc_GetBuyerGrowerCode", arParms)
    '        Return ds.Tables(0)
    '    Catch ex As Exception
    '        MsgBox(ex.ToString)
    '    End Try
    ...
    Public Function GetDuplicateUser(ByVal EL As ELParentMngt) As Data.DataTable
        ...
        para(1) = New SqlParameter("@Growerid", SqlDbType.VarChar, 50)
        para(1).Value = EL.Growerid
        para(2) = New SqlParameter("@BranchCode", SqlDbType.VarChar, 50)
        para(2).Value = HttpContext.Current.Session("BranchCode")
        para(3) = New SqlParameter("@RbType", SqlDbType.VarChar, 50)
        para(3).Value = EL.Rbid
        ...
        Return ds.Tables(0)
    End Function
    Public Function GetDDlGrowerName(ByVal RBId As String) As DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim ds As New DataSet
        ...
        arParms(2) = New SqlParameter("RBId", SqlDbType.VarChar, 50)
        arParms(2).Value = RBId

        ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "Proc_GetGrowerMangementNameDDL", arParms)
        Return ds.Tables(0)
    End Function
End Class
