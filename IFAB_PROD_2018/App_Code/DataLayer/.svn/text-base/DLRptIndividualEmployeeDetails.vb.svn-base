...
Public Class DLRptIndividualEmployeeDetails
    ...
    Shared Function GetIndividualEmpDetails(ByVal BranchName As String, ByVal Department As String, ByVal EmpType As String, ByVal EmpCat As String, ByVal EmpName As String) As DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim ds As New DataSet
        ...
        Return ds.Tables(0)
    End Function
    Public Function GetIndividualEmp(ByVal BranchName As String, ByVal Department As String, ByVal EmpType As String, ByVal EmpCat As String, ByVal EmpName As String) As DataTable
        Dim dt As DataTable
        dt = DLRptIndividualEmployeeDetails.GetIndividualEmpDetails(BranchName, Department, EmpType, EmpCat, EmpName)
