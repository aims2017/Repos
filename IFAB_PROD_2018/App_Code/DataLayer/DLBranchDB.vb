...
Public Class DLBranchDB
    ...
    Shared Function Insert(ByVal b As Branch) As Integer
        ...
        End If
        arParms(34) = New SqlParameter("@TinNo", SqlDbType.VarChar, 50)
        arParms(34).Value = b.Tin
        Try
    ...
    Shared Function Update(ByVal b As Branch) As Integer
        ...
        End If
        arParms(31) = New SqlParameter("@TinNo", SqlDbType.VarChar, 50)
        arParms(31).Value = b.Tin
