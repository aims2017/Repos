...
Public Class DLBuyerDetails
    ...
    Public Function RptGetGrowerPerformancebasedonAvg(ByVal FromDate As Date, ByVal ToDate As Date, ByVal GrowerId As Integer) As DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim ds As New DataSet
        Dim arParms() As SqlParameter = New SqlParameter(4) {}
        arParms(0) = New SqlParameter("@BranchCode", SqlDbType.VarChar, 50)
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "Rpt_GrowerPerformancebasedonAvg", arParms)
