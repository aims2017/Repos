...
Public Class EmployeeDB
    ...
    Shared Function EmpCombo(ByVal Branchcode As String) As System.Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim arParms() As SqlParameter = New SqlParameter(1) {}
        ...
        Dim ds As DataSet
        ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "New_EmpCombo", arParms)
        Return ds.Tables(0)
    End Function
