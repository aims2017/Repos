...
Public Class RptStudentAdmissionDetailsDL
    ...
    Shared Function GetBatch(ByVal AYear As String, ByVal Courseid As Integer) As DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim ds As New DataSet
        Try
            ...
            Parms(3) = New SqlParameter("@Courseid", SqlDbType.VarChar, 30)
            Parms(3).Value = Courseid

            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "[Proc_BatchComboforSDR]", Parms)
            Return ds.Tables(0)
        Catch ex As Exception
            Return Nothing
            MsgBox(ex.ToString)
    ...
    End Function
    Shared Function GetStudentAdmission(ByVal AYID As Integer, ByVal CourseID As Integer, ByVal BatchID As Integer, ByVal StudentID As Integer) As DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim ds As New DataSet
        Try
            ...
            Parms(5) = New SqlParameter("@StudentID", SqlDbType.Int)
            Parms(5).Value = StudentID
    ...
    End Function
    Shared Function GetStudentAdmissiondetails(ByVal AYID As Integer, ByVal CourseID As Integer, ByVal BatchID As Integer, ByVal StudentID As Integer) As DataTable
        Dim dt As DataTable
        dt = RptStudentAdmissionDetailsDL.GetStudentAdmission(AYID, CourseID, BatchID, StudentID)
