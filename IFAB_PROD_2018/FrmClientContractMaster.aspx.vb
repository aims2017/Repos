    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        Try
            ...
            If (Session("BranchCode") = Session("ParentBranch")) Then
                ...
                DdlSelectBranch.SelectedValue = (CType(GridView1.Rows(e.NewEditIndex).FindControl("lblBranch"), HiddenField).Value())
                DdlBilltype.SelectedValue = (CType(GridView1.Rows(e.NewEditIndex).FindControl("lblBillTypeId"), HiddenField).Value())
