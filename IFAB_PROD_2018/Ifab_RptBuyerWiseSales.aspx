<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="Ifab_RptBuyerWiseSales.aspx.vb" Inherits="Ifab_RptBuyerWiseSales" title="Buyer Wise Sales" %>
                ...
                <center>
                    <table>
                        <tr>
                            <td align="center">
                                <h1 class="headingTxt">
                                    <asp:Label ID="LabelEm" runat="server" Text="BUYER WISE SALES REPORT" SkinID="lblRepRsz"
