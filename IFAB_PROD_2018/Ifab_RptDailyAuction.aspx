<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="Ifab_RptDailyAuction.aspx.vb"
    Inherits="Ifab_RptDailyAuction" Title="Daily Auction Report" %>
                ...
                <center>
                    <table>
                        <tr>
                            <td align="center">
                                <h1 class="headingTxt">
                                    <asp:Label ID="LabelEm" runat="server" Text="DAILY AUCTION REPORT" SkinID="lblRepRsz"
                ...
                <center>
                    <table class="custTable">
                      <%--  <tr>
                        ...
                        <tr>
                            <td align="right">
                                <asp:Label ID="Label1" runat="server" Width="100px" Text="Date* :" SkinID="lblRsz"></asp:Label>
                            </td>
                            <td align="left">
