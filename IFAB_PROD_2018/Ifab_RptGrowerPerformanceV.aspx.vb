...
Partial Class Ifab_RptGrowerPerformanceV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DL.RptGetGrowerPerformance(fromdate, todate, GrowerId)
        Try
            If dt1.Rows.Count > 0 Then
                ReportViewer1.LocalReport.ReportPath = "Ifab_RptGrowerPerformance.rdlc"
                dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_GrowerPerformance", dt1)
