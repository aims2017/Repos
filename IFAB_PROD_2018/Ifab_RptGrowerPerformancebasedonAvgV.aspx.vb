...
Partial Class Ifab_RptGrowerPerformancebasedonAvgV

    Inherits System.Web.UI.Page
    Dim obj As New SelfDetailsB
    Dim dt1, dt, dt3 As New DataTable
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DL.RptGetGrowerPerformancebasedonAvg(fromdate, todate, GrowerId)
        Try
            If dt1.Rows.Count > 0 Then
                ReportViewer1.LocalReport.ReportPath = "Ifab_RptGrowerPerformancebasedonavg2.rdlc"
                dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_GrowerPerformancebasedonAvg", dt1)
