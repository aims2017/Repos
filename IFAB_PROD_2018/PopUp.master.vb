    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Session("FrmParentName") <> "" Then
                'The below line commented becuase displaying Branch and Institute Name not required for IFAB
                ...
                Me.lblUserName.Text = "User : " & IIf(Session("StudentName") Is DBNull.Value Or Session("StudentName") = "", Session("EmpName"), Session("StudentName"))
                lblSmallTitle.Text = Session("BranchName")
                lblTitle.Text = Session("InstituteName")
                Me.Image1.ImageUrl = Session("InstituteLogo")
