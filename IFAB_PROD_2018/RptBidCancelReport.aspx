<%@ Page Title="BID CANCELATION REPORT" Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="RptBidCancelReport.aspx.vb" Inherits="RptBidCancelReport" %>
                    ...
                    <table>
                         <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:ObjectDataSource ID="ObjBuyer" runat="server" SelectMethod="GetBuyerCombo" TypeName="DLRptBidCancelReport">
