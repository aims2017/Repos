Partial Class RptBidCancelReportV
    Inherits BasePage
    ...
    Dim DL As New DLRptBidCancelReport
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DLRptBidCancelReport.GetBidCancel(BuyerId, StartDate, EndDate)
        Try
            If dt1.Rows.Count > 0 Then
                ReportViewer1.LocalReport.ReportPath = "RptBidCancelReport.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_IFAB_BidCancelationReport", dt1)
