...
Partial Class Rpt_AttendanceDetailsV
    Inherits BasePage
    ...
    Dim DL As New DLRpt_AttendenceDetails
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DLRpt_AttendenceDetails.GetAttendenceDetails(Company, StartDate, EndDate)
        Try
            If dt1.Rows.Count > 0 Then
                ReportViewer1.LocalReport.ReportPath = "Rpt_AttendanceDetails.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_IFAB_AttendenceReport", dt1)
