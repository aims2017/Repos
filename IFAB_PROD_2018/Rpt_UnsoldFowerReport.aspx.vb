...
Partial Class Rpt_UnsoldFowerReport
    Inherits BasePage
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        If fromdateE > todateE Then
            ...
            Exit Sub
        End If
        Dim qrystring As String = "Rpt_UnsoldFowerReportV.aspx?" & QueryStr.Querystring() & "&StartDate=" & fromdateE & "&EndDate=" & todateE & "&Growerid=" & Growerid
