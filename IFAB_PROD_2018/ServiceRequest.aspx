<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="ServiceRequest.aspx.vb"
                ...
                <center>
                    <table>
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtuserName" runat="server" SkinID="txt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtPhNo" runat="server" SkinID="txt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlModule" runat="server" DataSourceID="ObjModule" DataTextField="ModuleName"
                                    DataValueField="MNIDAuto" SkinID="ddlRsz" TabIndex="3" Width="200">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlprority" runat="server" SkinID="ddl" TabIndex="1">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtDescription" runat="server" SkinID="txtRsz" TextMode="MultiLine"
                                    TabIndex="2" Height="80px" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtSerReqId" runat="server" SkinID="txtRsz" TabIndex="2" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btnSendReq" runat="server" CausesValidation="True" CssClass="ButtonClass"
                                    SkinID="btnRsz" Width="150px" OnClientClick="return Validate();" TabIndex="3"
                                    Text="SEND REQUEST" />
                                &nbsp;
                            </td>
                            <td>
                                <asp:Button ID="btnCheckStatus" runat="server" CssClass="ButtonClass" SkinID="btnRsz"
                                    Width="150px" TabIndex="4" Text="CHECK STATUS" />
                                &nbsp;
                            </td>
                        </tr>
                    </table>
