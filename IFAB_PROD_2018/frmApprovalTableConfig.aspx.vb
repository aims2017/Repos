...
Partial Class frmApprovalTableConfig
    ...
    Protected Sub BtnView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnView.Click
        ...
        If DDLTableMaster.SelectedValue = "Select" Then
            ...
            ddl4.Enabled = False
            ddl5.Enabled = False
            txtFifthEmpCode.Enabled = False
            txtFrstEmpCode.Enabled = False
            txtFrthEmpCode.Enabled = False
            txtScndEmpCode.Enabled = False
            txtThrdEmpCode.Enabled = False
        End If
        a = GlobalFunction.UserPrivilage()
        LinkButton1.Focus()
        ...
        If (Session("BranchCode") = Session("ParentBranch")) Then
            ...
            If a = 1 Or a = 2 Or a = 6 Or a = 7 Then
                ...
                Else
                    ...
                    txtFifthEmpCode.Text = CType(GVTblConfig.Rows(e.NewEditIndex).FindControl("lbl1name"), Label).Text.Trim
                    txtFrthEmpCode.Text = CType(GVTblConfig.Rows(e.NewEditIndex).FindControl("lbl2name"), Label).Text.Trim
                    txtThrdEmpCode.Text = CType(GVTblConfig.Rows(e.NewEditIndex).FindControl("lbl3name"), Label).Text.Trim
                    txtScndEmpCode.Text = CType(GVTblConfig.Rows(e.NewEditIndex).FindControl("lbl4name"), Label).Text.Trim
                    txtFrstEmpCode.Text = CType(GVTblConfig.Rows(e.NewEditIndex).FindControl("lbl5name"), Label).Text.Trim
                    If txtFifthEmpCode.Text = "" Then
                        txtFrstEmpCode.Enabled = False
                        txtScndEmpCode.Enabled = False
                        txtThrdEmpCode.Enabled = False
                        txtFrthEmpCode.Enabled = False
                    ElseIf txtFrthEmpCode.Text = "" Then
                        txtFrstEmpCode.Enabled = False
                        txtScndEmpCode.Enabled = False
                        txtThrdEmpCode.Enabled = False
                    ElseIf txtThrdEmpCode.Text = "" Then
                        txtFrstEmpCode.Enabled = False
                        txtScndEmpCode.Enabled = False
                    ElseIf txtScndEmpCode.Text = "" Then
                        txtFrstEmpCode.Enabled = False
                    End If
                End If
                BtnView.Text = "BACK"
