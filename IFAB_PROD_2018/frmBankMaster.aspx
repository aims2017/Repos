<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Home.master" CodeFile="frmBankMaster.aspx.vb"
                        ...
                        <center>
                            <table class="custTable">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBank" runat="server" Text='<%# Bind("Name")%>' SkinID="txt" TabIndex="1">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBankAdd" TextMode="MultiLine" AutoCompleteType="Disabled" runat="server"
                                            Text='<%# Bind("Address") %>' SkinID="txt" TabIndex="2"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRemarks" runat="server" Text='<%# Bind("Remarks") %>' AutoCompleteType="Disabled"
