<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="frmSelfDetails.aspx.vb"
    Inherits="frmSelfDetails" Title="Self Details" %>
            ...
            <center>
                ...
                <table id="TABLE1" class="custTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="ddlState" TabIndex="9" MaxLength="60" runat="server" SkinID="ddl">
