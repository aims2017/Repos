<%@ Page Language="VB" MasterPageFile="~/Home.master" AutoEventWireup="false" CodeFile="frmUserMgmt.aspx.vb"
    Inherits="frmUserMgmt" Title="User Management" %>
                    ...
                    <asp:Panel ID="addpanel" runat="server">
                        ...
                        <center>
                            <table class="custTable" style="background-color: White">
                                ...
                                <tr>
                                    <td>
                                        <asp:ListBox ID="RoleAddIndex" runat="server" Height="16px" Visible="False" Width="16px">
                                        </asp:ListBox>
                                    </td>
                                    <td>
