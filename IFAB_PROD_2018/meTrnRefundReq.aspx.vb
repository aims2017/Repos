...
Namespace RequestAndResponse
    ...
    Public Partial Class meTrnRefundReq
        ...
        Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As EventArgs)
            Try
                ...
                objReqMsgDTO.RefundAmt = txtRefundAmount.Text
                Dim objawlmerchantkit As com.awl.MerchantToolKit.AWLMEAPI = New com.awl.MerchantToolKit.AWLMEAPI()
                objResMsgDTO = objawlmerchantkit.refundTransaction(objReqMsgDTO)
                Session("response") = objResMsgDTO
                Response.Redirect("meTrnRefundSuccess.aspx", False)
