<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="meTrnRefundSuccess.aspx.vb"
    Inherits="RequestAndResponse.meTrnRefundSuccess" %>
    ...
    <div>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 16.66%">
                    <asp:Label  runat="server" Width="130">Refud Req ID</asp:Label>
                </td>
                <td style="width: 16.66%">
                    <asp:Label ID="txtRefundId" runat="server" Width="200"></asp:Label>
                </td>
                <td style="width: 10%; height: 10px">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 16.66%">
                    <asp:Label ID="lblRefundAmount" runat="server" Width="150">Refund Amount:</asp:Label>
                </td>
                <td style="width: 16.66%">
                    <asp:Label ID="txtRefundAmount" runat="server" Width="150"></asp:Label>
                </td>
                 <td style="width: 16.66%">
                    <asp:Label ID="lblStatus" runat="server" Width="150">Refund Transaction Status:</asp:Label>
                </td>
                <td>
                    <asp:Label ID="txtStatus" runat="server" Width="200"></asp:Label>
                </td>
                <td style="width: 16.66%">
                    <asp:Label ID="lblDescription" runat="server" Width="150">Refund Status Description:</asp:Label>
                </td>
                <td style="width: 16.66%">
